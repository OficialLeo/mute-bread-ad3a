...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mute-bread-ad3a)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/mute-bread-ad3a
```

A live public deployment of this template is available at [https://mute-bread-ad3a.templates.workers.dev](https://mute-bread-ad3a.templates.workers.dev)
